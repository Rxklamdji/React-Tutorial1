...
import "./Person.css";
import Radium from "radium";     // Importing this makes our webapp to be aware of thisstyling and don't forget to mention the extension 'css' but for js file u dont need to mention the extension
...
//ClassName "Person" is to bind this file to our css file for styling
    ...
    <div className="Person" style={stylePerson} /** To use this, we have to call another component "StyleRoot" in the main app root file "app.js" */>
...
export default Radium(person);    //Higher Order Component "Radium" wrapping our app to help us use some extra features, especially adding Hoover style on button   //Remember everything to hold our function, we have to export it by default, you always have to close it like this;
